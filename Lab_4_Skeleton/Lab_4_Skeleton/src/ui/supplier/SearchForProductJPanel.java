   ...
   Supplier supplier;
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        if(idField.getText() == null) {
            JOptionPane.showConfirmDialog(this, "Please enter a product id to search");
            return;
        }
        ...
        if(product == null) {
            JOptionPane.showConfirmDialog(this, "No products existz with product id "+ idField.getText());
            return;
        } 
        
        ViewProductDetailJPanel detailJPanel = new ViewProductDetailJPanel(workArea, product, supplier);
