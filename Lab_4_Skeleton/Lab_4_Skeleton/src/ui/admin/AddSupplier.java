...
public class AddSupplier extends javax.swing.JPanel {
    ...
    private void btnAddSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSupplierActionPerformed
        ...
        Logger.getGlobal().log(Level.INFO, "Supplier description = "+supplier.getDescription());
        
        System.out.println("Supplier description = "+supplier.getDescription());
        
        JOptionPane.showMessageDialog(this, "SupplierUpdated successfully added", "Warning", JOptionPane.INFORMATION_MESSAGE);
        backAction();
